object h_jogos: Th_jogos
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = 'Pesquisa de Jogos'
  ClientHeight = 504
  ClientWidth = 763
  Color = clWhite
  ...
  object Label1: TLabel
    ...
    Height = 13
    Caption = 
      'Selecione um intervalo de datas (se quiser de uma data espec'#237'fic' +
      'a, preencha somente a primeira op'#231#227'o).'
  end
  ...
  object DbGridJogos: TDBGrid
    ...
    OnCellClick = DbGridJogosCellClick
    OnDrawColumnCell = DbGridJogosDrawColumnCell
    OnDblClick = DbGridJogosDblClick
    Columns = <
      item
        Expanded = False
        FieldName = 'codjogo'
  ...
  object EdtDtIni: TEdit
    ...
    ParentFont = False
    TabOrder = 1
    OnChange = EdtDtIniChange
    OnEnter = EdtDtIniEnter
    OnExit = EdtDtIniExit
    OnKeyPress = EdtDtIniKeyPress
  end
