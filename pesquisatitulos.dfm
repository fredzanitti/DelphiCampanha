object h_titulos: Th_titulos
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = 'Pesquisa por T'#237'tulos'
  ClientHeight = 344
  ClientWidth = 388
  Color = clWhite
  ...
  object Label1: TLabel
    ...
    Width = 194
    Height = 13
    Caption = 'Digite o nome do Torneio (ou parte dele)'
  end
  object EdtPesquisa: TEdit
    ...
    Width = 257
    Height = 21
    Hint = 'Digite o nome do torneio (ou parte dele)'
  ...
  object DbGridTitulos: TDBGrid
    ...
    TitleFont.Style = []
    OnDblClick = DbGridTitulosDblClick
    Columns = <
      item
        Alignment = taCenter
        Expanded = False
