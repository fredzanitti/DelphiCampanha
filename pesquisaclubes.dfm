object h_clubes: Th_clubes
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = 'Pesquisa de Clubes'
  ClientHeight = 362
  ClientWidth = 604
  Color = clWhite
  ...
  object Label1: TLabel
    ...
    Width = 183
    Height = 13
    Caption = 'Digite o nome do clube (ou parte dele)'
  end
  object ImgClube: TImage
    Left = 496
    Top = 8
    Width = 73
    Height = 73
  ...
  object DbGridClubes: TDBGrid
    ...
    TitleFont.Style = []
    OnCellClick = DbGridClubesCellClick
    OnDrawColumnCell = DbGridClubesDrawColumnCell
    OnDblClick = DbGridClubesDblClick
    OnKeyUp = DbGridClubesKeyUp
    Columns = <
      item
        Expanded = False
        FieldName = 'codigo'
  ...
  object BtnIncluir: TBitBtn
    ...
    Width = 45
    Height = 45
    Hint = 'Adionar e/ou Editar Clube'
    Glyph.Data = {
