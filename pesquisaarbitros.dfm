object h_arbitros: Th_arbitros
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = 'Pesquisa de '#193'rbitros'
  ClientHeight = 347
  ClientWidth = 391
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 190
    Height = 13
    Caption = 'Digite o nome do '#225'rbitro (ou parte dele)'
  end
  ...
  object DbGridArbitro: TDBGrid
    ...
    OnDrawColumnCell = DbGridArbitroDrawColumnCell
    OnDblClick = DbGridArbitroDblClick
    Columns = <
      item
        Expanded = False
  ...
  object BtnIncluir: TBitBtn
    ...
    Width = 45
    Height = 45
    Hint = 'Adionar e/ou Editar '#193'rbitro'
    Glyph.Data = {
