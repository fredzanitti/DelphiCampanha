object h_fases: Th_fases
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = 'Pesquisar Fases'
  ClientHeight = 349
  ClientWidth = 385
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 179
    Height = 13
    Caption = 'Digite o nome da fase (ou parte dele)'
  end
  ...
  object DbGridFase: TDBGrid
    ...
    TitleFont.Style = []
    OnDrawColumnCell = DbGridFaseDrawColumnCell
    OnDblClick = DbGridFaseDblClick
    Columns = <
      item
        Expanded = False
        FieldName = 'codfase'
  ...
  object BtnIncluir: TBitBtn
    ...
    Width = 45
    Height = 45
    Hint = 'Adionar e/ou Editar Fases'
    Glyph.Data = {
