object h_patrocinador: Th_patrocinador
  Left = 0
  Top = 0
  Caption = 'Pesquisa de Patrocinadores'
  ClientHeight = 366
  ClientWidth = 593
  Color = clWhite
  ...
  object Label1: TLabel
    ...
    Width = 219
    Height = 13
    Caption = 'Digite o nome do patrocinador (ou parte dele)'
  end
  ...
  object DbGridPatroc: TDBGrid
    ...
    TitleFont.Style = []
    OnCellClick = DbGridPatrocCellClick
    OnDrawColumnCell = DbGridPatrocDrawColumnCell
    OnDblClick = DbGridPatrocDblClick
    OnKeyUp = DbGridPatrocKeyUp
    Columns = <
      item
        Expanded = False
        FieldName = 'codigo'
  ...
  object DtsQrPesquisa: TDataSource
    DataSet = QrPesquisa
    Left = 136
    Top = 312
  end
