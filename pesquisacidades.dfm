object h_cidades: Th_cidades
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = 'Pesquisa por Cidades'
  ClientHeight = 343
  ClientWidth = 583
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 189
    Height = 13
    Caption = 'Digite o nome da cidade (ou parte dele)'
  end
  ...
  object DbGridCidades: TDBGrid
    ...
    TitleFont.Style = []
    OnDrawColumnCell = DbGridCidadesDrawColumnCell
    OnDblClick = DbGridCidadesDblClick
    Columns = <
      item
        Alignment = taCenter
        Expanded = False
